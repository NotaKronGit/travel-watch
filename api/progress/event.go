...
func Decode(m kafka.Message) (*eventsv1.TripRouteBuildingUpdated, error) {
	...
	if count != 1 || len(m.Value) > 16384 || proto.Unmarshal(m.Value, e) != nil || e.PlannerId != "graph" || e.SchemaVersion != 1 || e.Revision < 1 || e.Revision == math.MaxInt64 || Stages[e.Stage] == "" || e.OccurredAt == nil || e.OccurredAt.CheckValid() != nil || e.Attempt < 0 || e.Attempt > 100 || e.DurationMs < 0 || e.RouteCount < 0 || e.RouteCount > 50 {
