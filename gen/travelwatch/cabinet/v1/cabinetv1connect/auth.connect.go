...
const (
	...
	AuthServiceName = "travelwatch.cabinet.v1.AuthService"
)
...
const (
	...
	AuthServiceRegisterProcedure = "/travelwatch.cabinet.v1.AuthService/Register"
	// AuthServiceLoginProcedure is the fully-qualified name of the AuthService's Login RPC.
	AuthServiceLoginProcedure = "/travelwatch.cabinet.v1.AuthService/Login"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/travelwatch.cabinet.v1.AuthService/Logout"
	// AuthServiceGetCurrentUserProcedure is the fully-qualified name of the AuthService's
	// GetCurrentUser RPC.
	AuthServiceGetCurrentUserProcedure = "/travelwatch.cabinet.v1.AuthService/GetCurrentUser"
)

// AuthServiceClient is a client for the travelwatch.cabinet.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the travelwatch.cabinet.v1.AuthService service. By
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_travelwatch_cabinet_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// Register calls travelwatch.cabinet.v1.AuthService.Register.
...
// Login calls travelwatch.cabinet.v1.AuthService.Login.
func (c *authServiceClient) Login(ctx context.Context, req *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return c.login.CallUnary(ctx, req)
}

// Logout calls travelwatch.cabinet.v1.AuthService.Logout.
...
// GetCurrentUser calls travelwatch.cabinet.v1.AuthService.GetCurrentUser.
...
// AuthServiceHandler is an implementation of the travelwatch.cabinet.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/travelwatch.cabinet.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("travelwatch.cabinet.v1.AuthService.Register is not implemented"))
}

func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.LoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("travelwatch.cabinet.v1.AuthService.Login is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("travelwatch.cabinet.v1.AuthService.Logout is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) GetCurrentUser(context.Context, *connect.Request[v1.GetCurrentUserRequest]) (*connect.Response[v1.GetCurrentUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("travelwatch.cabinet.v1.AuthService.GetCurrentUser is not implemented"))
}
