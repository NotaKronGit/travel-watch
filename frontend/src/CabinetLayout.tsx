...
const CabinetMenu = () => <Menu><Menu.Item to="/account" primaryText="Личный кабинет" leftIcon={<PersonOutlineIcon />} /><Menu.Item to="/trips" primaryText="Мои заявки" /><Menu.Item to="/trips/create" primaryText="Создать заявку" /></Menu>;
